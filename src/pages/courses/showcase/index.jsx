...
import styles from "../../../styles/courses/showcase.module.css";
          ...
          <div className={styles.showcaseTextContainer}>
            <div className={styles.showcaseText}>
              ...
              <div className={styles.showcaseTextDescription}>
                <p>
                  Discover a wide range of programming courses designed to help
                  you enhance your skills and grow in your career. Whether you
                  are a beginner or an experienced developer, we have something
                  for everyone.{" "}
                </p>
              </div>
